...
Provides a helper to send combined context and a user question to the Gemini
model and return its answer. Includes basic retry logic for transient errors.
...
def _supported_models() -> list[str]:
    """
    Return a prioritized list of candidate model names. Includes latest suffixes
...
def ask_gemini(context: str, question: str, model_name: str = "gemini-1.5-pro") -> str:
    """
    Send context and question to Gemini, return answer.

    Args:
        context: Combined Slack and Confluence context string.
        question: User question.
        model_name: Preferred model to use first.

    Returns:
        Answer string generated by Gemini.
    """
